      ...
      return (
        <div className="mdui-prose">
          ...
          >
            ...
            Schülern und 3 Wahlen länger dauern als das Universum alt ist. Es
            gäbe nämlich {Math.pow(3, 100)} mögliche Kombinationen. So lange
            wollen wir nicht warten. Deshalb optimiert ein schlauer Algorithmus
            für uns. Die Berechnungsdauer hängt von der Anzahl der Schüler und
            der Anzahl der Wahlen ab. Bei vielen Schülern und Wahlen kann es
            einige Sekunden dauern. Gleich ist es fertig.
          </div>
        </div>
      );
    }
        ...
        <div className="mdui-prose">
          ...
          >
            ...
            <div style={{ color: "gray" }}>
              ...
              angewendet, in der sie hier aufgelistet sind. Die Regeln werden
              auf die Schüler angewendet, die die Bedingungen erfüllen. Die
              Punkte geben an, wie viele Punkte die Schüler für die jeweilige
              Wahl erhalten. Die Regeln können auf verschiedene Kriterien
              angewendet werden. Die Kriterien sind in der Form{" "}
              <code>key=value</code> angegeben. Mehrere Kriterien können durch
              Kommas getrennt werden. Die Kriterien sind:
              <ul>
                <li>
          ...
          >
            ...
            >
              ...
              >
                <div
                  style={{ gap: "10px", textWrap: "nowrap", display: "flex" }}
                >
